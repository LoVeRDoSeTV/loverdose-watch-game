...
const SHOP_ITEMS = [
  ...
  { key:'frame_gold', category:'frame', subcategory:'special', name:'Cadre doré', price:450, preview:'gold', description:'Encadrement doré premium.' },
  { key:'frame_rose', category:'frame', subcategory:'special', name:'Cadre rose néon', price:400, preview:'rose', description:'Encadrement rose vif avec éclat néon.' },
  { key:'frame_obsidian', category:'frame', subcategory:'special', name:'Cadre obsidienne', price:450, preview:'obsidian', description:'Encadrement sombre premium aux reflets froids.' },
  { key:'frame_royal', category:'frame', subcategory:'special', name:'Cadre royal', price:500, preview:'royal', description:'Encadrement bleu royal aux accents dorés.' },
