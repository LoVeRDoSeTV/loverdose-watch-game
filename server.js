...
const SHOP_ITEMS = [
  ...
  { key:'bg_flag_france', category:'background', subcategory:'flags', name:'Fond France', price:500, preview:'flag-france', description:'Fond inspiré du drapeau français.' },
  { key:'bg_flag_belgium', category:'background', subcategory:'flags', name:'Fond Belgique', price:500, preview:'flag-belgium', description:'Fond inspiré du drapeau belge.' },
  { key:'bg_flag_uk', category:'background', subcategory:'flags', name:'Fond Royaume-Uni', price:500, preview:'flag-uk', description:'Fond inspiré du drapeau britannique.' },
  { key:'bg_flag_usa', category:'background', subcategory:'flags', name:'Fond États-Unis', price:500, preview:'flag-usa', description:'Fond inspiré du drapeau américain.' },
  { key:'bg_flag_canada', category:'background', subcategory:'flags', name:'Fond Canada', price:500, preview:'flag-canada', description:'Fond inspiré du drapeau canadien.' },
  { key:'bg_flag_spain', category:'background', subcategory:'flags', name:'Fond Espagne', price:500, preview:'flag-spain', description:'Fond inspiré du drapeau espagnol.' },
  { key:'bg_flag_portugal', category:'background', subcategory:'flags', name:'Fond Portugal', price:500, preview:'flag-portugal', description:'Fond inspiré du drapeau portugais.' },
  { key:'bg_flag_japan', category:'background', subcategory:'flags', name:'Fond Japon', price:500, preview:'flag-japan', description:'Fond inspiré du drapeau japonais.' },
